...
describe "#inspect and #to_s on a foreign" do
  ...
  describe "recursive array" do
    it "gives a similar representation to Ruby" do
      ...
      foreign[0] = foreign
      foreign.inspect.should =~ /\A#<Foreign Polyglot::ForeignObject:0x\h+ \[\[...\], 2, 3\]>\z/
  ...
  guard -> { !TruffleRuby.native? } do
    describe "array" do
      it "gives a similar representation to Ruby" do
        ...
        foreign.inspect.should =~ /\A#<Foreign Polyglot::ForeignObject:0x\h+ \[1, 2, 3\]>\z/
        foreign.to_s.should == "#<Foreign [foreign array]>"
      end
      ...
      it "gives a similar representation to Ruby, even if it is also a pointer" do
        ...
        foreign.inspect.should =~ /\A#<Foreign Polyglot::ForeignObject pointer 0x\h+ \[1, 2, 3\]>\z/
